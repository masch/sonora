// CSS-mapped component factory for the Tailwind-style wrappers.
// Kept in a non-component module (no JSX, no components) so the barrel file
// `@/tw` only exports components from a Fast Refresh perspective.
...
export const TwTextBase = cssComponent<React.ComponentProps<typeof RNText>>(
  RNText,
  { className: 'style' },
  'TwText',
);
