...
function seedQueue(entries: { id: string; tripId: string; message: string }[]): void {
...
describe('useFeedbackSync', () => {
  it('should flush all pending entries on online transition', async () => {
    seedQueue([
      { id: 'key-1', tripId: 'trip-1', message: 'First' },
      { id: 'key-2', tripId: 'trip-1', message: 'Second' },
    ]);
  ...
  it('should handle partial failure — remove succeeded, keep failed', async () => {
    seedQueue([
      { id: 'key-1', tripId: 'trip-1', message: 'First' },
      { id: 'key-2', tripId: 'trip-1', message: 'Second' },
      { id: 'key-3', tripId: 'trip-1', message: 'Third' },
    ]);
  ...
  it('should not double-flush on rapid online/offline toggle', async () => {
    seedQueue([{ id: 'key-1', tripId: 'trip-1', message: 'Only one' }]);
