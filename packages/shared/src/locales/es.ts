export const es = {
  ...
  payments: {
    ...
    restore: {
      title: 'Descargar con tu email',
      description:
        'Ingresá tu email para descargar y escuchar gratis esta experiencia o restaurar una compra previa.',
      emailPlaceholder: 'correo@ejemplo.com',
      button: 'Obtener experiencia',
      notFound: 'No se pudo validar el acceso para este email',
      invalidEmail: 'Por favor ingresá un email válido',
      success: 'Acceso habilitado correctamente',
      link: '¿Querés escucharla gratis? Ingresá tu email',
      linkQuestion: '¿Querés escucharla gratis?',
      linkAction: 'Ingresá tu email',
    },
