export const en = {
  ...
  payments: {
    ...
    restore: {
      title: 'Download with your email',
      description:
        'Enter your email to download and listen to this experience for free or restore a previous purchase.',
      emailPlaceholder: 'email@example.com',
      button: 'Get experience',
      notFound: 'Could not validate access for this email',
      invalidEmail: 'Please enter a valid email address',
      success: 'Access granted successfully',
      link: 'Want to listen for free? Enter your email',
      linkQuestion: 'Want to listen for free?',
      linkAction: 'Enter your email',
    },
