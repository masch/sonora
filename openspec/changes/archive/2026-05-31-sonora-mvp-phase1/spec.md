...
1. **Initial Proximity Check:** Target radius set to **50 meters** (tightened from 150m during implementation after field testing indicated 50m provides reliable activation in open areas with standard GPS accuracy).
