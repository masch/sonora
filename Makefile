...
.PHONY: api-upload-private-audio-staging
api-upload-private-audio-staging: ## Upload an audio file to staging private R2 bucket. Usage: make api-upload-private-audio-staging FILE="path/to/file.mp3" KEY="experiences/name.mp3"
	@if [ -z "$(FILE)" ] || [ -z "$(KEY)" ]; then \
		echo "Error: FILE and KEY parameters are required. Example: make api-upload-private-audio-staging FILE=\"/path/to/audio.mp3\" KEY=\"experiences/audio.mp3\""; \
		exit 1; \
	fi
...
.PHONY: api-upload-private-audio-production
api-upload-private-audio-production: ## Upload an audio file to production private R2 bucket. Usage: make api-upload-private-audio-production FILE="path/to/file.mp3" KEY="experiences/name.mp3"
	@if [ -z "$(FILE)" ] || [ -z "$(KEY)" ]; then \
		echo "Error: FILE and KEY parameters are required. Example: make api-upload-private-audio-production FILE=\"/path/to/audio.mp3\" KEY=\"experiences/audio.mp3\""; \
		exit 1; \
	fi
